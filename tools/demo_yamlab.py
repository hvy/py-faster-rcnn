...
def demo(net, image):
    ...
    for cls_ind, cls in enumerate(CLASSES[1:]):
        ...
        dets = dets[keep, :]
        vis_detections(im, cls, dets, filename=image['im_name'], thresh=CONF_THRESH)
...
if __name__ == '__main__':
    ...
    prototxt = '/home/ubuntu/code/forked/py-faster-rcnn/models/coco/VGG16/faster_rcnn_end2end/test.prototxt'
    caffemodel = '/home/ubuntu/code/forked/py-faster-rcnn/output/faster_rcnn_end2end/coco_2014_train/vgg16_faster_rcnn_iter_5000.caffemodel'
